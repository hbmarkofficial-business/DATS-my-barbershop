  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | DATS my Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop DATS my Barbershop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="DATS my Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="DATS my Barbershop | Premium Barbershop Berlin" />
        <meta
